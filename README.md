...
reel: {
  ...
  poster: "assets/img/hero.jpg",       // кадр 12:5, его видно, пока видео грузится
  video: { kind: "drive", id: "..." }, // или { kind: "mp4", src: "assets/video/reel.mp4" }
                                       // или { kind: "youtube", id: "..." }
...
Клик по шоурилу открывает его большим окном со звуком. Работает для `drive` и `mp4`;
